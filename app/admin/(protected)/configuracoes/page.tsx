...
import { Settings2, ShieldCheck, GitBranch, Percent, Users2, Lock } from 'lucide-react';
      ...
      <header className="adm-page-header">
        <div>
          ...
          <p className="adm-page-sub">
            Sessão: <strong style={{ color: 'var(--text)' }}>{session?.name}</strong>{' '}
                ...
                {plans.map(p =>
                  isMaster ? (
                    ...
                    <tr key={p.id}>
                      ...
                      <td data-label="Mensalidade" className="adm-table-value">
                        {brl(p.monthly_cents)}
                      </td>
                    </tr>
                  )
        ...
        <section className="adm-card">
          ...
          {isMaster ? (
            ...
            <table className="adm-table">
              ...
              <tbody>
                <tr>
                  <td className="adm-table-muted">Direto (N1)</td>
                  <td className="adm-table-value">{commCfg.direct_pct}%</td>
                </tr>
                <tr>
                  <td className="adm-table-muted">Rede N2</td>
                  <td className="adm-table-value">{commCfg.level1_pct}%</td>
                </tr>
                <tr>
                  <td className="adm-table-muted">Rede N3</td>
                  <td className="adm-table-value">{commCfg.level2_pct}%</td>
                </tr>
                <tr>
                  <td className="adm-table-muted">Rede N4</td>
                  <td className="adm-table-value">{commCfg.level3_pct}%</td>
                </tr>
                <tr>
                  <td className="adm-table-muted">Rede N5</td>
                  <td className="adm-table-value">{commCfg.level4_pct}%</td>
                </tr>
              </tbody>
            </table>
          )}
        ...
        <section className="adm-card">
          ...
          {isMaster ? (
            ...
            <table className="adm-table">
              ...
              <tbody>
                <tr>
                  <td className="adm-table-muted">Padrão</td>
                  <td className="adm-table-value">{cashCfg.standard_pct}%</td>
                </tr>
                <tr>
                  <td className="adm-table-muted">Premium</td>
                  <td className="adm-table-value">{cashCfg.premium_pct}%</td>
                </tr>
                <tr>
                  <td className="adm-table-muted">Limite premium</td>
                  <td className="adm-table-value">{brl(cashCfg.premium_threshold_cents)}</td>
                </tr>
                <tr>
                  <td className="adm-table-muted">Duração</td>
                  <td className="adm-table-value">{cashCfg.duration_months} meses</td>
                </tr>
                <tr>
                  <td className="adm-table-muted">Crédito</td>
                  <td className="adm-table-value">Dia {cashCfg.credit_day}</td>
                </tr>
              </tbody>
            </table>
          )}
        ...
        {isMaster && (
          <section className="adm-card" style={{ gridColumn: '1 / -1' }}>
            ...
            <div className="adm-card-note" style={{ marginTop: '1rem' }}>
              ...
              <span className="adm-badge adm-badge--elite adm-badge--xs">master</span> — acesso
              total + edição
              {' · '}
              <span className="adm-badge adm-badge--prime adm-badge--xs">financeiro</span> — saques,
              PIX, extrato
              {' · '}
              <span className="adm-badge adm-badge--start adm-badge--xs">suporte</span> — usuários,
              dashboard
            </div>
          </section>
        )}
          ...
          <section className="adm-card" style={{ gridColumn: '1 / -1', textAlign: 'center' }}>
            <div className="adm-cfg-lock">
              <Lock
                size={28}
                strokeWidth={1.4}
                style={{ color: 'var(--text-soft)', opacity: 0.5 }}
              />
